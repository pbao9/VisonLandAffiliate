...
class SettingController extends Controller
{
    ...
    $settings = $this->repository->getByGroup([SettingGroup::Account]);

    return view($this->view['account'], compact('settings'));
}
    public function commission(){
    $settings = $this->repository->getByGroup([SettingGroup::Commission]);

    return view($this->view['commission'], compact('settings'));
    }
