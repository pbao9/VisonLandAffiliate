...
namespace App\Admin\DataTables\Areas;
...
class AreasDataTable extends BaseDataTable
{

    use GetConfig;

    // ID ( Client ) của bảng DataTable
    protected $nameTable = 'areasTable';
    ...
    {
        $this->customColumns = $this->traitGetConfigDatatableColumns('area'); // Truyền vào tên bảng trong datatable_columns Config
    }
