...
namespace App\Admin\DataTables\ContactAdmin;

use App\Admin\DataTables\BaseDataTable;
use App\Admin\Repositories\ContactAdmin\ContactAdminRepositoryInterface;
use App\Admin\Traits\GetConfig;

class ContactAdminDataTable extends BaseDataTable
{

    use GetConfig;
	
	// ID ( Client ) của bảng DataTable
	protected $nameTable = 'ContactAdminTable';
    ...
    public function getView(){
        return [
			'id' => 'admin.ContactAdmin.datatable.id',
			
            'action' => 'admin.ContactAdmin.datatable.action',
        ];
    }
    ...
    protected function setCustomColumns(){
        $this->customColumns = $this->traitGetConfigDatatableColumns('ContactAdmin'); // Truyền vào tên bảng trong datatable_columns Config
    }
