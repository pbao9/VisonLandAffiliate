...
class ServeCommand extends Command
{
    ...
    public function handle()
    {
        $environmentFile = $this->option('env')
                            ? base_path('.env_backup').'.'.$this->option('env')
                            : base_path('.env_backup');
    ...
    protected function getOptions()
    {
        return [
            ...
            ['no-reload', null, InputOption::VALUE_NONE, 'Do not reload the development server on .env_backup file changes'],
        ];
    }
}
