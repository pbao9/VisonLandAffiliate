...
trait InteractsWithDockerComposeServices
{
    ...
    /**
     * Replace the Host environment variables in the app's .env_backup file.
     *
     * @param  array  $services
     * @return void
     */
    ...
    {
        $environment = file_get_contents($this->laravel->basePath('.env_backup'));
        ...
        file_put_contents($this->laravel->basePath('.env_backup'), $environment);
    }
