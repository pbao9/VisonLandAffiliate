                ...
                <div class="col">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('listOfNotification') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header justify-content-between">
                    <h2 class="mb-0">{{ __('listOfNotification') }}</h2>
                    <x-link :href="route('admin.notification.create')" class="btn btn-primary"><i
                            class="ti ti-plus"></i>{{ __('addNotification') }}</x-link>
                </div>
                <div class="card-body">
